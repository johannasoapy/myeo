...
add_image_size( 'bones-thumb-300', 340, 280, true );
...
function bones_custom_image_sizes( $sizes ) {
    return array_merge( $sizes, array(
        ...
        'bones-thumb-300' => __('340px by 280px'),
        'bones-thumb-300' => __('150px by 150px'),
    ) );
}
...
function bones_register_sidebars() {
	...
	register_sidebar(array(
		'id' => 'sidebar2',
		'name' => __( 'Programs Sidebar', 'bonestheme' ),
		'description' => __( 'Sidebar for Our Programs pages.', 'bonestheme' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
	...
	register_sidebar(array(
		'id' => 'sidebar3',
		'name' => __( 'Impact Sidebar', 'bonestheme' ),
		'description' => __( 'Sidebar for Our Impact pages.', 'bonestheme' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
	...
	register_sidebar(array(
		'id' => 'sidebar4',
		'name' => __( 'Get Involved Sidebar', 'bonestheme' ),
		'description' => __( 'Sidebar for Get Involved pages.', 'bonestheme' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
	...
	register_sidebar(array(
		...
		'description' => __( 'Sidebar for About Us pages.', 'bonestheme' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
...
// Re-order the Testimonials (quotes) archive page by menu order
